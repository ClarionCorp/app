...
pub type MonitorFlag = Arc<std::sync::Mutex<Option<Arc<AtomicBool>>>>;

#[tauri::command]
pub fn read_log_from(path: String, offset: u64) -> Result<(String, u64), String> {
...
pub fn read_log_from_offset(path: &str, offset: u64) -> Result<(String, u64), String> {
    let mut opts = OpenOptions::new();
    opts.read(true);
...
#[tauri::command]
pub fn find_session_start(path: String) -> Result<u64, String> {
    let mut opts = OpenOptions::new();
    opts.read(true);
...
#[tauri::command]
pub fn start_log_monitor(app: AppHandle, path: String, offset: u64) {
...
#[tauri::command]
pub fn stop_log_monitor(app: AppHandle) {
    let state = app.state::<MonitorFlag>();
...
pub fn regex_my_character(line: &str) -> Option<String> {
