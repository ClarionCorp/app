import { appSettings, auth, currentMatch, customLobby, gameSessions, matchHistory, matchPlayers, user } from "../core/database/schema";
...
export type GameSessionsTable = typeof gameSessions.$inferSelect;
