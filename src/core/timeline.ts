...
export async function checkSaveTimelineEntries(matchTable: CurrentMatchTable, matchJSON: MatchJSON) {
  if (!matchTable || matchTable.teamOnePts == null || matchTable.teamTwoPts == null || matchTable.teamOneSets == null || matchTable.teamTwoSets == null) {
    console.error(`Tried saving timeline entry but something was null!`, matchTable);
    return;
  };
