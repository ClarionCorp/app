    ...
    abilities: [
      {
        ...
        tags: ['Melee'],
        cooldown: 0.9,
        description: "(Closed) Knock the Core with a LIGHT hit that has greater force generated by the point of the umbrella."
      },
      {
        type: 'Strike',
        title: "Strike",
        ...
        tags: ['Melee'],
        cooldown: 0.9,
        description: "(Open) Knock the Core in a direction with a LIGHT MELEE hit."
      },
      {
        type: 'Primary',
        ...
        tags: ['Melee', 'Impact'],
        cooldown: 10.5,
        description: "(Closed) Hook all targets in a line towards you."
      },
      {
        type: 'Primary',
        title: "Top Spin",
        ...
        tags: ['Melee', 'Impact'],
        cooldown: 14,
        description: "(Open) LIGHTLY hit all enemies in a line, pushing them towards the top of the umbrella. The umbrella will then spin rapidly, dealing multiple LIGHT hits leading up to a final, more powerful flourish."
      },
      {
        type: 'Secondary',
        title: "The Slip",
        ...
        tags: ['Dash'],
        cooldown: 12,
        description: "(Closed) Dash a short distance, passing by all targets."
      },
      {
        type: 'Secondary',
        title: "Carried Away",
        ...
        tags: ['Dash'],
        cooldown: 16,
        description: "(Open) Float up in the air, becoming Elusive. Elusive targets are invulnerable and untargetable."
      },
      {
        type: 'Special',
        title: "Pop / Retract",
